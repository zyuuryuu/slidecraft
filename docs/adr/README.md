...
| [0030](0030-binding-plan-single-authority.md) | BindingPlan＝束縛の単一 authority（`resolveBinding`/`slideBindingPlan` で観測合成・段階的 A–E・段階A は byte-identical＋診断のみ増える＝#97/#135/#128 の silent-drop を surface） | Accepted（段階A 実装済） |
