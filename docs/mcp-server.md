...
| 読む | `get_slide(index)` | 1スライドの**構造化 read**：resolvedLayout・hasFigure/figureKind・bulletCount・budget・overBudget・当該 issues・notes（`<!-- note -->` スピーカーノート本文、無ければ null）・markdown（1呼び出しで編集計画） |
