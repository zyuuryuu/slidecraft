...
**オーサリング拡張**（ノート記法 #150・章タグ/目次 #151＝出荷済・後続は #167/#168・ADR-0032 系）。
...
| **オーサリング表現力（ADR-0032）** | アジェンダ再掲・フッタ章名（#151 出荷でブロック解除）／ネスト箇条書き | #167 #168・#103 |
| **パーサ / 診断（変換レポートの完成）** | パース時フォールバック計上・列内表/混在本文・グループセル見出し・GUI コメント段落（要判断） | #148 #100 #101 #102 #165 |
...
| **表・描画 / HTML** | 図ノード衝突/折返し・SmartArt 追随・@font-face CJK 埋め込み | #104 #105 #115 |
