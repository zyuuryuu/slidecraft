/**
 * sample-deck.ts — The default sample deck (Markdown) shown on first load.
 * Pure data, split out of App.tsx to keep it within the 400-line rule (R1).
 * Showcases every native diagram/chart type + layouts; edit freely.
 */

export const SAMPLE_MD = `<!-- slide: Title.1Title.Single -->
# NextGen CRM プロジェクト
## 移行計画レビュー
